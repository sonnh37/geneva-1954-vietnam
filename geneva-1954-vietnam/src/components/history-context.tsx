  ...
  const data = [
    {
      ...
      content: (
        <div>
          ...
          <p className="text-neutral-200 text-xl md:text-2xl font-normal mb-8">
            Mỹ không thực hiện tổng tuyển cử thống nhất đất nước, thay vào đó
            dựng lên chính quyền Ngô Đình Diệm ở miền Nam và tiến hành chiến
            tranh xâm lược.
          </p>
          <p className="text-neutral-200 text-xl md:text-2xl font-normal mb-8">
            Mỹ chính thức đưa quân vào Việt Nam: lính thủy đánh bộ Mỹ đổ bộ vào
            Đà Nẵng, mở đầu chiến lược "Chiến tranh cục bộ".
          </p>
      ...
      content: (
        <div>
          <p className="text-neutral-200 text-xs md:text-2xl font-normal mb-4">
            Mỹ thực hiện chiến lược "Việt Nam hóa chiến tranh": Rút quân dần,
            trao vai trò chiến đấu cho quân đội Việt Nam Cộng hòa.
          </p>
          <p className="text-neutral-200 text-xs md:text-2xl font-normal mb-4">
            Chủ tịch Hồ Chí Minh qua đời (2/9/1969): Gây xúc động lớn đối với
